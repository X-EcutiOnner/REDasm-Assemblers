...
typedef enum {
    ...
    MIPS_INSTRUCTIONS_COUNT
} MIPSInstructionId;

typedef struct UNKFormat {
    unsigned : 21;
    unsigned code : 5;
    unsigned op : 6;
} UNKFormat;
...
typedef struct IFormatUnsigned {
    unsigned imm : 16;
    unsigned rt : 5;
    unsigned rs : 5;
    unsigned op : 6;
...
typedef struct BFormat {
    unsigned funct : 6;
    unsigned code : 20;
    unsigned op : 6;
} BFormat;

typedef struct C1IMMFormat {
    unsigned imm : 11;
    unsigned fs : 5;
    unsigned rt : 5;
    unsigned code : 5;
